...
if(isset( $_GET['txtID'] )){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM categoria WHERE id_categoria=:id_categoria");
...
if($_POST){
        ...
        $sentencia=$conexion->prepare("UPDATE  categoria SET nombre_categoria=:nombre_categoria 
