...
<body>
    ...
    if(isset($_GET['txtID'])) {
        ...
        $sentencia = $conexion->prepare("DELETE FROM categoria WHERE id_categoria=:id_categoria");
       ...
       <div class="main">
           <nav class="navbar navbar-expand px-3 border-bottom">
            ...
            <?php if(isset($_GET['mensaje'])) { ?>
                <script>
                    Swal.fire({icon:"sucess", title:"<?php echo $_GET['mensaje']; ?>"});
                </script>
            <?php } ?>
            ...
            <div class="container mt-5">
                ...
                <h2>CATEGORÍA</h2>
                    <a class="btn btn-success" href="crear.php" role="button">Agregar categoría</a>
                        ...
                        <tbody>
                            <?php foreach ($lista_categoria as $registro) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn" href="editar.php?txtID=<?php echo $registro["id_categoria"]; ?>" role="button">Editar</a>
                                        <a class="btn" href="javascript:borrar(<?php echo $registro["id_categoria"]; ?>)" role="button">Eliminar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
