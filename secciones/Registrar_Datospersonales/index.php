...
if(isset( $_GET['txtID'] )){
    ...
    $sentencia=$conexion->prepare("DELETE FROM datos_persona WHERE id_datos_persona=:id_datos_persona");
...
$sentencia=$conexion->prepare("SELECT * FROM `datos_persona`");
$sentencia->execute();
$lista_datos_persona=$sentencia->fetchALL(PDO::FETCH_ASSOC);
...
<a
       ...
       <table id="tabla_id" class="table table-dark table-striped">
        ...
        <tbody>
            <?php foreach ($lista_datos_persona as $registro) { ?>

                    <tr class="">
                    <td scope="row"><?php echo $registro["id_datos_persona"]; ?></td>
                    <td><?php echo $registro["nombre_1"]; ?></td>
                    <td><?php echo $registro["nombre_2"]; ?></td>
                    <td><?php echo $registro["apellido_1"]; ?></td>
                    <td><?php echo $registro["apellido_2"]; ?></td>
                    ...
                    <a
                            class="btn"
                            href="editar.php?txtID=<?php echo $registro["id_datos_persona"]; ?>"
                            role="button"
                            >Editar</a
                        >
                        <a
                            class="btn"
                            href="javascript:borrar(<?php echo $registro["id_datos_persona"]; ?>)"
                            role="button"
                            >Eliminar</a
                        >
