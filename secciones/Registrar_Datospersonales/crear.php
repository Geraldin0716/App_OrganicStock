...
print_r($_POST);
    ...
    $sentencia=$conexion->prepare("INSERT INTO datos_persona(id_datos_persona,nombre_1,nombre_2,apellido_1,apellido_2,direccion,telefono,correo) 
                VALUES (null, :nombre_1,:nombre_2,:apellido_1,:apellido_2,:direccion,:telefono,:correo)");
