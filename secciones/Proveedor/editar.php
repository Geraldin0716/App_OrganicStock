...
if (isset($_GET['txtID'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM proveedor WHERE id_proveedor=:id_proveedor");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE proveedor SET pagina_web=:pagina_web, id_datos_persona=:id_datos_persona WHERE id_proveedor=:id_proveedor");

    // Asignando los valores que vienen del método POST
    $sentencia->bindParam(":pagina_web",$pagina_web);
