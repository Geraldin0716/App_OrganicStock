...
if(isset( $_GET['txtID'] )){
    ...
    $sentencia=$conexion->prepare("DELETE FROM huerta WHERE id_huerta=:id_huerta");
...
$sentencia = $conexion->prepare("SELECT * FROM `huerta`");
$sentencia->execute();
       ...
       <table id="tabla_id" class="table table-dark table-striped">
        ...
        <tbody>
            <?php foreach ($lista_huerta as $registro) { ?>
                    ...
                    <tr class="">
                    <td scope="row"><?php echo $registro["id_huerta"]; ?></td>
                    <td><?php echo $registro["lote"]; ?></td>
                    <td><?php echo $registro["direccion"]; ?></td>
                    <td><?php echo $registro["tipo_cultivo"]; ?></td>
                    ...
                    <a
                            class="btn"
                            href="editar.php?txtID=<?php echo $registro["id_huerta"]; ?>"
                            role="button"
                            >Editar</a
                        >
                        <a
                            class="btn"
                            href="javascript:borrar(<?php echo $registro["id_huerta"]; ?>)"
                            role="button"
                            >Eliminar</a
                        >
