...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("INSERT INTO producto(id_producto,nombre,precio,fecha,cantidad,id_huerta,id_categoria,gastos) 
                VALUES (null, :nombre,:precio,:fecha,:cantidad,:id_huerta,:id_categoria,:gastos)");
...
<div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <div class="mb-3">
                <label for="fecha" class="form-label">Id categoria</label>
                <input
                    type="date"
                    class="form-control"
                    name="fecha"
