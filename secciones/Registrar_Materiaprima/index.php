...
if(isset( $_GET['txtID'] )){
    ...
    $sentencia=$conexion->prepare("DELETE FROM producto_consumible WHERE id_producto_consumible=:id_producto_consumible");
...
$sentencia = $conexion->prepare("SELECT * FROM `producto_consumible`");
$sentencia->execute();
$lista_producto_consumible = $sentencia->fetchAll(PDO::FETCH_ASSOC);
...
<a
       ...
       <table id="tabla_id" class="table table-dark table-striped">
        ...
        <tbody>
            <?php foreach ($lista_producto_consumible as $registro) { ?>

                    <tr class="">
                    <td scope="row"><?php echo $registro["id_producto_consumible"]; ?></td>
                    <td><?php echo $registro["nombre"]; ?></td>
                    <td><?php echo $registro["cantidad"]; ?></td>
                    <td><?php echo $registro["tipo"]; ?></td>
                    <td><?php echo $registro["certificado"]; ?></td>
                    ...
                    <a
                            class="btn"
                            href="editar.php?txtID=<?php echo $registro["id_producto_consumible"]; ?>"
                            role="button"
                            >Editar</a
                        >
                        <a
