...
print_r($_POST);
    ...
    $sentencia=$conexion->prepare("INSERT INTO producto_consumible(id_producto_consumible,nombre,cantidad,tipo,certificado,detalles,precio) 
                VALUES (null, :nombre,:cantidad,:tipo,:certificado,:detalles,:precio)");
